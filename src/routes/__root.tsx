...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cleans HRMS — Outlet Management System" },
      {
        name: "description",
        content: "A modern management system for Cleans laundry & dry cleaning outlets.",
      },
      { property: "og:title", content: "Cleans HRMS" },
      {
